...
const Settings = () => {
  ...
  const handleNotificationPrefChange = (
    ...
    setPreferencesForm((prev) => {
      const sectionKey = section as keyof typeof prev.notificationPreferences
      const sectionData = prev.notificationPreferences[sectionKey]
      
      if (!sectionData || typeof sectionData !== 'object') {
        return prev
      }
      
      const categoryKey = category as keyof typeof sectionData
      const categoryData = sectionData[categoryKey]
