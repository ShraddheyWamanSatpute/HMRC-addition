...
import { AuthGuard } from '../../../yourstop/frontend/src/components/auth-guard';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link to="/YourStop" className="text-2xl font-bold text-gray-900">
                BookMyTable
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              >
                <Link to="/YourStop/profile#personal">Update Personal Info</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              >
                <Link to="/YourStop/profile#dietary">Set Dietary Preferences</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              >
                <Link to="/YourStop/profile#payment">Manage Payment Methods</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 text-white">
              ...
              >
                <Link to="/YourStop/profile">Complete Profile</Link>
              </Button>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
              ...
              >
                <Link to="/YourStop/profile">View Profile</Link>
              </Button>
            </div>
          </div>
        </div>
