...
import {
  ...
  CardHeader,
  CardTitle,
} from '../../../yourstop/frontend/src/components/ui/card';
...
import { customerBookingService, CustomerBooking, BookingFilters } from '../../../yourstop/frontend/src/lib/customer-booking-service';
import { toast } from '../../../yourstop/frontend/src/hooks/use-toast';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from '../../../yourstop/frontend/src/components/ui/alert-dialog';
import { BookingModifyModal } from '../../../yourstop/frontend/src/components/booking-modify-modal';
                ...
                {filter === 'past' && booking.status === 'completed' && (
                  <>
                    ...
                    <Button asChild variant="outline" size="sm">
                      <Link to={`/YourStop/restaurants/${booking.restaurantId}`}>
                        Book Again
                      </Link>
                    </Button>
                  </>
        ...
        <div className="text-center py-12">
          ...
          {filter === 'upcoming' && (
            <Button asChild className="mt-4">
              <Link to="/YourStop/explore">Explore Restaurants</Link>
            </Button>
          )}
        </div>
      )}
