...
import { ReviewsSection } from '../../../yourstop/frontend/src/components/reviews-section';
import { RestaurantMap } from '../../../yourstop/frontend/src/components/restaurant-map';
import { BookingModal } from '../../../yourstop/frontend/src/components/booking-modal';
import { ShareButton } from '../../../yourstop/frontend/src/components/share-button';
import { openGoogleMapsDirections } from '../../../yourstop/frontend/src/lib/maps';
...
import { apiFetch } from '../../../yourstop/frontend/src/lib/api-client';
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <Button variant="ghost" onClick={() => navigate(-1)} className="h-8 sm:h-9 px-2 sm:px-3">
              <ChevronLeft className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              <span className="text-xs sm:text-sm">Back</span>
            </Button>
            <div className="flex items-center gap-1 sm:gap-2">
              <ShareButton
                url={`${typeof window !== 'undefined' ? window.location.origin : ''}/YourStop/restaurants/${restaurant.id}`}
